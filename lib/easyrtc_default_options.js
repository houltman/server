...
option.appIceServers = [                                    // Array of STUN and TURN servers. By default there is only publicly available STUN servers.
    ...
    Username:"experto-e",
     ...
     {urls:"turn:experto-e.com:5349?transport=udp",
    credential:"experto-e",
    Username:"experto-e",
    },
    {urls:"turn:experto-e.com:5349?transport=tcp",
    credential:"experto-e",
    Username:"experto-e",
    }
*/
...
option.roomDefaultName      = "salon1";                    // The default room a connection joins if it is not initially specified.
...
option.demosPublicFolder    = "/salon-experto";                     // Demos public folder without trailing slash. This sets the public URL where where demos are hosted, such as http://yourdomain/demos/
