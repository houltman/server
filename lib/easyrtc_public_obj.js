...
pub.util.getErrorText = function(errorCode) {
    switch (errorCode) {
        case "BANNED_IP_ADDR":
            ...
            return "La dirección IP del cliente está prohibida. El zócalo se desconectará";
            break;
        case "LOGIN_APP_AUTH_FAIL":
            //return "Authentication for application failed. Socket will be disconnected.";
            return "Error en la autenticación de la aplicación. El zócalo se desconectará";
            break;
        case "LOGIN_BAD_APP_NAME":
            //return "Provided application name is improper. Socket will be disconnected.";
            return "El nombre de la aplicación es incorrecto. El zócalo se desconectará";
            break;
        case "LOGIN_BAD_AUTH":
            //return "Authentication for application failed. Socket will be disconnected.";
            return "Error en la autenticación de la aplicación. El zócalo se desconectará.";
        ...
        case "LOGIN_BAD_ROOM":
            //return "Requested room is invalid or does not exist. Socket will be disconnected.";
             return "Error El Salon solicitado no es válida o no existe. El zócalo se desconectará.";
            break;
        ...
        case "MSG_REJECT_TARGET_EASYRTCID":
            ...
            return "Mensaje rechazado. El destino easyrtcid no es válido, no utiliza la misma aplicación o ya no está en línea.";
            break;
        case "MSG_REJECT_TARGET_GROUP":
            //return "Message rejected. Target group is invalid or not defined.";
            return "Mensaje rechazado. El grupo de destino no es válido o no está definido."
            break;
        case "MSG_REJECT_TARGET_ROOM":
            //return "Message rejected. Target room is invalid or not created.";
            return "Mensaje rechazado. La habitación objetivo es inválida o no creada.";
            break;
        case "SERVER_SHUTDOWN":
            return "Server is being shutdown. Socket will be disconnected.";
            return "El servidor se está apagando. El zócalo se desconectará.";
            break;
        default:
